...
function wrapper(my) {
    ...
    return function(req, start) {
        ...
        function finish() {
            return cleanup(), first[1] ? (story._bytesDispatched += soc._bytesDispatched, story.bytesRead += soc.bytesRead, 
            req.transferRate = oi(story, first, !0), req.transferRate) : void 0;
        }
        function cleanup() {
